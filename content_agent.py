...
def scrape(url: str):
    ...
    response = requests.post(
        "https://chrome.browserless.io/content?token=" + BROWSERLESS_TOKEN, headers=headers, data=data_json)
...
user_proxy.initiate_chat(
    writing_assistant, message="write a blog about different Prompt Engineering techniques.")
